...
const int blueLed = 3; // Pin connected to yellow LED
...
int switchVal;
const int quietKnock = 20; // Set min value that will be accepted
const int loudKnock = 50; // Set max value that will be accepted
boolean locked = false; // A true or false variable
int numberOfKnocks = 0; // Value for number of knocks

void setup() {
  servo9.attach(9);
  pinMode(blueLed, OUTPUT); // Set LED pins as outputs
